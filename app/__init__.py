...
def seed_initial_data():
    ...
    if Usuario.query.count() == 0:
        ...
        usuarios = [
            Usuario(documento='584-53-0773', contrasena='123456', nombres='Julian', apellidos='Ortega', telefono='429-233-4414', email='julian@gmail.com', direccion='7 Northland Circle', ciudad='Río Grande', created_at=datetime.strptime('5/27/2024', '%m/%d/%Y'), updated_at=datetime.strptime('2/5/2025', '%m/%d/%Y'), rol_id=1),
