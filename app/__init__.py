...
def seed_initial_data():
    ...
    if Usuario.query.count() == 0:
        ...
        usuarios = [
            Usuario(documento='584-53-0773', contrasena='123456', nombres='Julian', apellidos='Ortega', telefono='429-233-4414', email='julian@gmail.com', direccion='7 Northland Circle', ciudad='Río Grande', created_at=datetime.strptime('5/27/2024', '%m/%d/%Y'), updated_at=datetime.strptime('2/5/2025', '%m/%d/%Y'), rol_id=1, parqueadero_id=1),
            Usuario(documento='742-87-8089', contrasena='hE5}y">#<', nombres='Neils', apellidos='Levesque', telefono='254-498-1366', email='nlevesque1@canalblog.com', direccion='077 Mesta Alley', ciudad='Fresnes', created_at=datetime.strptime('9/26/2024', '%m/%d/%Y'), updated_at=datetime.strptime('7/22/2024', '%m/%d/%Y'), rol_id=2, parqueadero_id=1),
            Usuario(documento='688-93-3923', contrasena='aK2>ej*pKId61', nombres='Florette', apellidos='Docket', telefono='871-919-4896', email='fdocket2@blogspot.com', direccion='170 Eagle Crest Crossing', ciudad='Xiashan', created_at=datetime.strptime('3/26/2024', '%m/%d/%Y'), updated_at=datetime.strptime('9/14/2024', '%m/%d/%Y'), rol_id=2, parqueadero_id=1),
            Usuario(documento='812-93-0345', contrasena='vZ7{E)AU{k|Sj=Pw', nombres='Hinda', apellidos='Seaborne', telefono='100-274-5002', email='hseaborne3@163.com', direccion='6838 Becker Parkway', ciudad='Lau', created_at=datetime.strptime('11/21/2024', '%m/%d/%Y'), updated_at=datetime.strptime('1/27/2025', '%m/%d/%Y'), rol_id=2, parqueadero_id=1),
            Usuario(documento='197-64-5442', contrasena='dP8.25v}Yu8{', nombres='Jens', apellidos='Kerne', telefono='812-593-5940', email='jkerne4@tripod.com', direccion='5 Ilene Terrace', ciudad='Beitan', created_at=datetime.strptime('10/22/2024', '%m/%d/%Y'), updated_at=datetime.strptime('2/18/2024', '%m/%d/%Y'), rol_id=2, parqueadero_id=1),
        ]
